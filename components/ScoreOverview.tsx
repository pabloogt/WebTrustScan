    ...
    result.score >= 85
      ...
      : result.score >= 70
        ...
        : result.score >= 50
          ? {
              label: "Mejorable",
              ring: "border-orange-500/40 text-orange-300 bg-orange-500/10",
    ...
    <div className="grid gap-6 lg:grid-cols-[320px_1fr]">
      <div className="bg-slate-900 border border-slate-800 rounded-2xl p-6">
        ...
        <div className="mt-5">
          ...
          >
            Nivel {scoreMeta.label}
          </span>
        </div>

        <p className="mt-5 text-sm text-slate-300">{result.summary}</p>
        <p className="mt-2 text-xs text-slate-500 leading-relaxed">
          Esta puntuación refleja señales visibles de configuración y seguridad
          básica. No sustituye una auditoría técnica completa.
        </p>
      </div>

      <div className="bg-slate-900 border border-slate-800 rounded-2xl p-6">
        <p className="text-sm text-slate-400">URL final analizada</p>
